                        ...
                        <c:choose>
                             ...
                             <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
	                                ...
	                                <li>
	                                    <!-- 修改 href属性的值 -->
	                                    <a href="${pageContet.request.contextPath }/user/logout">
            ...
            <table class="table table-hover table-striped table-bordered">
		        ...
		        <tr>
		            <td colspan="5" class="foot-msg">
			            ...
			            <!-- 修改 href属性值 -->
			            <a href="${pageContext.request.contextPath }/cart/show"><button class="btn btn-warning pull-right ">返回</button></a>
			
			            <button id="createOrder"  class="btn btn-warning pull-right margin-right-15" data-toggle="modal" data-target="#buildOrder" >生成订单</button>
