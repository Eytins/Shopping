        ...
        <div class="clear-bottom head">
            <div class="container head-cc">
                ...
                <div class="welcome">
                    ...
                    <div class="right"> ${staff.loginName} </div>
                    <!-- 添加  id="logout" -->
                    <div class="exit" id="logout">退出</div>
                </div>
            </div>
        </div>
        <!-- header end -->
        ...
        <div class="container-flude flude-cc" id="a">
            <div class="row user-setting">
                ...
                <div class="col-xs-9" id="userPanel">
                    <iframe id="frame-id" src="${pageContext.request.contextPath }/type/findAll" width="100%"
