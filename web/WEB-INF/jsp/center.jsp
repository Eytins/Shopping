            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle user-active" data-toggle="dropdown" role="button">
                        <img class="img-circle" src="${pageContext.request.contextPath}/images/user.jpeg" height="32"
                             id="headImg"/>
    ...
    <form class="form-horizontal" action="${pageContext.request.contextPath }/user/modifyUser">
        <div class="form-group">
            ...
            <div class="col-md-8 col-sm-10">
                <input type="text" class="form-control" id="name" name="name" placeholder="用户姓名" readonly="readonly"
                       value="${user.userName }">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-md-8  col-sm-10">
                <input type="text" class="form-control" id="loginName" name="loginName" placeholder="登陆账号"
                       readonly="readonly" value="${user.loginName }">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-8 col-sm-10">
                <input type="text" class="form-control" id="address" name="address" placeholder="联系电话"
                       value="${user.address }">
            </div>
        </div>
        <div class="form-group">
...
<div class="container">
    ...
    -->
    <form action="${pageContext.request.contextPath }/attache/modifyHeadImage" class="form-horizontal" method="post"
          enctype="multipart/form-data">
        <div class="form-group">
            ...
            <div class="col-md-10 col-sm-10">
                ...
                <c:choose>
                    <c:when test="${empty headImg}">
                        <!-- 修改 img的src属性值 -->
                        <img src="${pageContext.request.contextPath }/images/add.png" id="showImg" class="togeImg"
                             onclick="openImg()" alt="" width="100" height="100">
                    </c:when>
                    <c:otherwise>
                        <img src="${pageContext.request.contextPath }${headImg.filePath }" id="showImg" class="togeImg"
                             onclick="openImg()" alt="" width="100" height="100">
                    </c:otherwise>
                </c:choose>
    ...
    <!--
                  ...
                  enctype="multipart/form-data"
            -->
    <form id="uploadLifeForm" action="${pageContext.request.contextPath }/attache/uploadLifeImage"
        ...
        <div class="form-group" id="d">
            ...
            <div class="col-md-10 col-sm-10">
                <c:forEach items="${lifeImgs}" var="lifeImg">
                    <img src="${pageContext.request.contextPath }${lifeImg.filePath }" id="showImgs" class="togeImg"
                         onclick="openFile()" alt="" width="100" height="100">
                    <button type="button" class="btn btn-warning margin-right-15" name="delete">删除</button>
                </c:forEach>
                <img src="${pageContext.request.contextPath }/images/add.png" id="showImgs" class="togeImg"
                     onclick="openFile.call(this)" alt="" width="100" height="100">
                <input type="file" style="display: none;" id="lifeImgFile" name="file" chanageFile="clickFileInput"
                       onchange="showImg.call(this)"/>
                <button type="button" class="btn btn-warning margin-right-15" name="delete"
                        onclick="deleteFile.call(this)">删除
                </button>
                <script>
                    function openFile() {
                        $(this).next().click();
