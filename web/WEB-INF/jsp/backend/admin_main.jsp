...
<head>
    ...
    $(function(){
	    ...
	    $("#product-set").click(function() {
	        $("#frame-id").attr("src", "${pageContext.request.contextPath }/skip/productManager");
	    });
	    $("#product-type-set").click(function() {
	        $("#frame-id").attr("src", "${pageContext.request.contextPath }/skip/productTypeManager");
	    });
	    $("#manager-set").click(function() {
	        $("#frame-id").attr("src", "${pageContext.request.contextPath }/skip/staffManager");
	    });
	    $("#dept-set").click(function() {
	        $("#frame-id").attr("src", "${pageContext.request.contextPath }/skip/deptManager");
	    });
        $("#exit").click(function () {
            ...
            <div class="clear-bottom head">
                <div class="container head-cc">
                    ...
                    <div class="welcome">
                        ...
                        <div class="right"><%=session.getAttribute("staff")%></div>
            ...
            <div class="container-flude flude-cc" id="a">
                <div class="row user-setting">
                    ...
                    <div class="col-xs-9" id="userPanel">
                        <iframe id="frame-id" src="${pageContext.request.contextPath }/skip/productTypeManager" width="100%" height="100%" frameborder="0" scrolling="no">
                    </div>
