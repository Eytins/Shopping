...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/bootstrapValidator.js"
            ...
            <form action="${pageContext.request.contextPath}staff/login" class="form-horizontal ccc" method="post"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        ...
                        <img class="img-rounded create-code" src="${pageContext.request.contextPath}code/show"
