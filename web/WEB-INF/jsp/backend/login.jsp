...
<html>
  <head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/bootstrapValidator.css" type="text/css"/>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/login.css" type="text/css"></link>
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/jquery.min.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/bootstrap.min.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/bootstrapValidator.js" charset="utf-8"></script>
    ...
    <div class="containercc div-signin">
      <div class="panel panel-primary div-shadow">
	    ...
	    <div class="panel-body">
	      <!-- login form start -->   
	      <form action="${pageContext.request.contextPath}/staff/login" class="form-horizontal ccc" method="post" id="loginFrm">
	        ...
	        <%--  <div>----------------------------------${code}</div> --%>
		     ...
		     <div class="form-group">
		       ...
		       <div class="col-sm-9">
		         <input class="form-control" type="text" placeholder="请输入用户名"  id="loginName" name="loginName" data-toggle="tooltip">
		       </div>
		     </div>
		     ...
		     <div class="form-group">
		       ...
		       <div class="col-sm-9">
		       	 <select class="form-control" data-toggle="tooltip" id="role" name="role">
		     ...
		     <div class="form-group">
		       ...
		       <div class="col-sm-4">
		         <input class="form-control" type="text" placeholder="请输入验证码" data-toggle="tooltip" name="code" >
		       </div>
		       <div class="col-sm-2">
		       	  <!-- 验证码图片加载(需引入验证码文件)图像高度经过测试,建议不要修改 -->
			      <img class="img-rounded create-code"  src="${pageContext.request.contextPath}/code/show" alt="验证码" style="height: 32px; width: 70px;"/>
		       </div>
