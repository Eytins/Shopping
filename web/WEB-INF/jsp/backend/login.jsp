...
<div class="containercc div-signin">
    <div class="panel panel-primary div-shadow">
        ...
        <div class="panel-body">
            <!-- login form start -->
            <form action="#" class="form-horizontal ccc" method="get" id="loginFrm">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input class="form-control" type="password" placeholder="请输入密码" id="pwd" name="pwd"
                               data-toggle="tooltip">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input class="form-control" type="text" placeholder="请输入验证码" data-toggle="tooltip">
                    </div>
                    <div class="col-sm-2">
