...
<div class="containercc div-signin">
    <div class="panel panel-primary div-shadow">
        ...
        <div class="panel-body">
            <!-- login form start -->
            <form class="form-horizontal ccc" method="post" action="${pageContext.request.contextPath}/staff/login">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input class="form-control" type="text" id="check" placeholder="请输入验证码">
                        <font id="trueorfalse"></font>
                    </div>
                    <div class="col-sm-2">
