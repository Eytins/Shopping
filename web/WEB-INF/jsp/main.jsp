...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            ${pageProductList.pages }";
	               }
	               var options = {
	                                  bootstrapMajorVersion : 3,
	                                  currentPage           : "

            ${pageProductList.pageNum }",
	                                  totalPages            : pages,
	                                  size                  : "normal",
	                                  aligment              : "center",
	                                  // 无条件查询时使用
            ...
            ${pageContext.request.contextPath }/product/findProductFuzzyParamList?pageNo=" + page;
	                                  // }
	                                  // 带参数查询使用
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <c:choose>
                    <c:when test="${empty user }">
                        <li>
                            <!-- 修改href属性 -->
                            <a href="${pageContext.request.contextPath }/user/logout" data-toggle="modal"
                               data-target="#loginModal">登陆</a>
                        </li>
                    ...
                    <c:otherwise>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    <a href="${pageContext.request.contextPath }/user/modifyPassword"
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <!-- 添加:
                            ...
                            method="post"
                    -->
            <form class="form-inline hot-search" id="searchForm"
                  action="${pageContext.request.contextPath }/product/findProductFuzzyParamList" method="post">
...
<div class="modal fade" id="modifyPasswordModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <!-- 修改密码 提交到后台  -->
            <form action="${pageContext.request.contextPath }/user/modifyPassword" class="form-horizontal"
                  method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2 input-height">
                            <!-- 添加img标签 -->
                            <img id="image" alt="验证码加载失败" src="${pageContext.request.contextPath }/code/show"
                                 class="img-rounded" style="height: 32px; width: 70px;"/>
                        </div>
