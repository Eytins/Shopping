...
<head>
    ...
    <!-- 添加bootstrap分页js -->
    <script type="text/javascript" src="${pageContext.request.contextPath }/js/bootstrap-paginator.js"></script></head>
	                ...
	                $.ajax(
	                {
	                    ...
	                    data :  {
	                      ...
	                      success  :  function(result)
	                      {
	                           if (result.responseCode == 1)
	                           {
	                                location.href = "${pageContext.request.contextPath }/staff/findFuzzyByParams?pageNo=${pageStaffList.pageNum }";
	                           }else
	                           {
	                                $("#errorMsg").tooltip(
	                                {
    ...
    <div class="panel panel-default" id="adminSet">
        ...
        <div class="panel-body">
            <div class="showmargersearch">
                ...
                -->
                <form class="form-inline" id="searchForm" method="post" action="${pageContext.request.contextPath }/staff/findFuzzyByParams" >
                ...
                <div class="modal-dialog modal-lg">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body text-center">
                            ...
                            <br>
                            <div class="row text-right">
                                <label for="marger-adrees" class="col-sm-4 control-label">邮箱:</label>
                                <div class="col-sm-4">
                        ...
                        <c:forEach items="${pageStaffList.list }" var="staff" varStatus="i">
	                        <tr>
	                            ...
	                            <td class="text-center">
	                                ...
	                                <input type="button" class="btn btn-warning btn-sm doMangerModify" value="修改" data-id="${staff.staffId }" >
	                                ...
	                                <c:if test="${staff.isValid eq 0 }">
		                                ...
		                                -->
		                                <input type="button" class="btn btn-danger btn-sm doMangerDisable" value="启用" data-id="${staff.staffId }" data-status="${staff.isValid }">
	                                </c:if>
	                                ...
	                                <c:if test="${staff.isValid eq 1 }">
		                                <!-- 添加  
		                                        ...
		                                        data-status="${staff.isValid }" 
		                                -->
		                                <input type="button" class="btn btn-danger btn-sm doMangerDisable" value="禁用" data-id="${staff.staffId }" data-status="${staff.isValid }">
	                                </c:if>
	                            </td>
	                        </tr>
                        </c:forEach>
