	                  ...
	                  $.ajax(
	                  {
	                       ...
	                       success  : function(result)
	                       {
	                            if (result.responseCode == 1)
	                            {
	                                 ...
	                                 location.href = "${pageContext.request.contextPath }/cart/show";
	                            }else
	                            {
	                                 $("#carMsg").tooltip(
	                                 {
		            ...
		            <ul class="nav navbar-nav navbar-right">
		                ...
		                <c:choose>
		                     ...
		                     <c:otherwise>
		                      ...
		                      <li class="userName"> 您好:${user.userName }</li>
		                   ...
		                   <li class="dropdown">
		                      ...
		                      <ul class="dropdown-menu">
	                              ...
	                              <!-- 修改href属性值 -->
			                      <li>
                                    <a href="${pageContext.request.contextPath }/user/showCenter" data-toggle="modal" data-target="#modifyPasswordModal">
                ...
                <table class="table table-hover table-striped table-bordered">
	                ...
	                <c:forEach items="${cart.items}" var="item" varStatus="i">
		                <tr>
		                    ...
		                    <td>
		                        <!-- 添加  name="modify" -->
		                        <button class="btn btn-success" type="button" name="modify"> <span class="glyphicon glyphicon-edit" aria-hidden="true"></span>修改</button>
	                ...
	                <tr>
	                    <td colspan="7" align="right">
	                        ...
	                        <!-- 修改href属性值 -->
	                        <a href="${pageContext.request.contextPath}/cart/settleAccounts"><button class="btn btn-warning " type="button" > 结算</button></a>
	                    </td>
