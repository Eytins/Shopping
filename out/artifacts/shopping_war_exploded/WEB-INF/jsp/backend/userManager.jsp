...
<head>
    ...
    <!-- 引入nmms.css文件 -->
    <link rel="stylesheet" href="${pageContext.request.contextPath }/css/nmms.css" type="text/css"/>
    ...
    <!-- 引入bootstrap插件 -->
    <script type="text/javascript" src="${pageContext.request.contextPath }/js/bootstrap-paginator.js"
            charset="utf-8"></script>
    ...
    <div class="panel-body">
        <div class="showusersearch">
            ...
            <form class="form-inline" id="searchForm"
                  action="${pageContext.request.contextPath }/user/findByFuzzyParamList" method="post">
                ...
                <c:forEach items="${pageUserList.list }" var="user" varStatus="i">
                    <tr>
                        ...
                        <td class="text-center">
		                    ...
		                    -->
                            <input type="button" class="btn btn-warning btn-sm doModify" value="修改" name="toModifyUser"
                                   data-value="${user.userId }">
                            ...
                            <c:if test="${user.isValid eq 1 }">
                                ...
                                <input type="button" class="btn btn-danger btn-sm doDisable" value="禁用"
                                       name="modifyStatus" data-id="${user.userId }" data-value="${user.isValid }">
                            </c:if>
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                        ...
                        <br>
                        <div class="row text-right">
                            <label for="modifyUserName" class="col-sm-4 control-label">姓名:</label>
                            <div class="col-sm-4">
                                <!--
                                id="username"
                                id="modifyUserName"
                        ...
                        <br>
                        <div class="row text-right">
                            <label for="modifyLoginName" class="col-sm-4 control-label">帐号:</label>
                            <div class="col-sm-4">
                                <!--
                                id="loginName"
                                id="modifyLoginName"
                        ...
                        <br>
                        <div class="row text-right">
                            <label for="modifyAddress" class="col-sm-4 control-label">地址:</label>
                            <div class="col-sm-4">
                                <!--
                                id="adrees"
                                id="modifyAddress"
